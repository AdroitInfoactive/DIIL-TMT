                                ...
                                <select name="organization" id="organization" class="select2 form-control">
                                    ...
                                    @foreach ($clients as $client)
                                        <option value="{{ $client->id }}"
                                            @if (old('organization') == $client->id) selected @endif>{{ $client->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '#organization', function(e) {
                ...
                if (org_id != '') {
                    $.ajax({
                        type: "GET",
                        url: "{{ route('order.get-client-details', ':org_id') }}".replace(
                            ':org_id', org_id),
                            ...
                            var clientHTML =
                                ...
                                `, ` + client.pincode + `</td>
                                    ...
                                    <tr>
                                        ...
                                        <td bgcolor="#EEEEEE"><strong>Primary Contact :</strong>` + client
                                .primary_name + `</td>
