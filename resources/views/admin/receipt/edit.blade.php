                ...
                <form action="{{ route('receipt.update', $receipt->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <select name="client_id" id="client_id" class="select2 form-control">
                                    ...
                                    @foreach ($clients as $client)
                                        <option value="{{ $client->id }}"
                                            @if ($receipt->client_id == $client->id) selected @endif>{{ $client->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label>Amount *</label>
                                <input type="text" name="received_amount" value="{{ $receipt->received_amount }}"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select name="transaction_type" id="transaction_type" class="select2 form-control">
                                    ...
                                    <option value="cash" @if ($receipt->transaction_type == 'cash') selected @endif>Cash</option>
                                    <option value="cheque" @if ($receipt->transaction_type == 'cheque') selected @endif>Cheque</option>
                                    <option value="bank transfer" @if ($receipt->transaction_type == 'bank transfer') selected @endif>Bank
                                        Transfer</option>
                                    <option value="others" @if ($receipt->transaction_type == 'others') selected @endif>Others</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="transaction_id" value="{{ $receipt->transaction_reference }}"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" cols="30" rows="10" class="form-control">{{ $receipt->description }}</textarea>
                            </div>
                        </div>
                    </div>
