...
use App\Models\OrderMasterAccepted;
...
class OrderMasterAcceptedDataTable extends DataTable
{
    /**
     ...
     */
    public function query(OrderMasterAccepted $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('ordermasteraccepted-table')
    ...
    {
        return 'OrderMasterAccepted_' . date('YmdHis');
    }
}
